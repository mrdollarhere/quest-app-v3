export const vi = {
  ...
  startQuiz: "Vào thi",
  // Hero
  heroBadge: "Nền tảng đánh giá và phân tích trí tuệ chuyên nghiệp.",
  heroTitle: "Đánh giá chính xác. Kết quả tức thì.",
  heroSubtitle: "Khai phá tiềm năng thông qua các mô-đun tương tác. Truy cập kho lưu trữ kiến thức và theo dõi quá trình phát triển với độ chính xác tuyệt đối.",
  browseTests: "Khám phá ngân hàng đề",
  tryDemo: "Thử bản mẫu",
  stat1: "Nhiều câu hỏi",
